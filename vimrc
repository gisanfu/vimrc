...
nnoremap <f6> <Esc>:w<CR>:call system('/bin/gisanfu-cmd-refresh-firefox.sh refresh')<cr>

" 如果只是想在browser中查資料，而不需新refresh，那就按F7好了
:imap <f7> <Esc>:w<CR>:call system('/bin/gisanfu-cmd-refresh-firefox.sh switchonly')<cr>
vnoremap <f7> <Esc>:w<CR>:call system('/bin/gisanfu-cmd-refresh-firefox.sh switchonly')<cr>
nnoremap <f7> <Esc>:w<CR>:call system('/bin/gisanfu-cmd-refresh-firefox.sh switchonly')<cr>
